...
public class Countries {
    ...
    public void countryAlphabetVerification() {
        loginPage();
//        List<WebElement> listOfRows3 = driver.findElements(By.cssSelector(".row a"));
//        for (WebElement listOfColumns3 : listOfRows3)
//            listOfColumns3.click();

        // получаем список всех строк стран
